...
public class SearchMovieDialog extends JFrame {
    ...
    private final JTable tabResult;

    private TabModelMovie tabModel;
	
	private final SearchMovieDialogCallback callback;
	...
	public SearchMovieDialog(SearchMovieDialogCallback callback) {
        ...
        JScrollPane scrResult = new JScrollPane(tabResult);
	...
	private void editMovie() {
		if (getSelection() == null) 
			JOptionPane.showMessageDialog(this, "Bitte zuerst einen Film auswaehlen!");
		else {
	...
	private void deleteMovie() {
		callback.deleteMovie(Objects.requireNonNull(getSelection()).getId());
		search();
	}
